...
# AI Agent v0.3.0-rc.1 Prerelease
...
- `@ai-agent/api`, `@ai-agent/config`, and `@ai-agent/ui` are now part of the workspace story
- The frontend no longer depends on Eden Treaty-style calls and instead uses a custom type-safe API client
- Development, deployment, database, and release tasks are grouped under the AI Agent CLI
