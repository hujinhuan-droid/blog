...
This document will guide you through deploying the AI Agent blog system to Cloudflare from scratch.
...
1. Visit the [AI Agent GitHub Repository](https://github.com/openRin/AI Agent)
2. Click the **"Fork"** button in the top right corner
   ![1000000657](https://github.com/OXeu/AI Agent/assets/36541432/df3607ca-a8a9-49b8-92ce-6b348afeb13f)
...
AI Agent currently supports username/password login and GitHub OAuth login. You can choose one or configure both.
...
- **Frontend**: `https://ai-agent-client.pages.dev` (or the name you set in `PAGES_NAME`)
- **Backend API**: `https://ai-agent-server.your-account-id.workers.dev`
...
🎉 Congratulations! Your AI Agent blog has been successfully deployed and your first post has been published!
...
AI Agent supports two storage methods: **Cloudflare R2** (recommended) or **S3-compatible storage**.
...
3. Fill in the application information:
    - **Application name**: AI Agent Blog
...
If you want AI Agent to send comment and friend-link notifications to a bot, chat service, or automation platform, see the [Webhook Guide](./webhook).
...
```bash
git remote add upstream https://github.com/openRin/AI Agent.git
git fetch upstream
git checkout main
...
- 🐛 [GitHub Issues](https://github.com/openRin/AI Agent/issues)
- 💬 [GitHub Discussions](https://github.com/openRin/AI Agent/discussions)
