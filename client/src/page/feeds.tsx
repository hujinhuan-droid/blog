...
import { siteName, HUGO_REPO_URL } from "../utils/constants"
        ...
        <>
            ...
            <Waiting for={feeds.draft.size + feeds.normal.size + feeds.unlisted.size > 0 || status === 'idle'}>
                <main className="w-full flex flex-col justify-center items-center mb-8">
                    ...
                    <a href={HUGO_REPO_URL} target="_blank" rel="noreferrer"
                        ...
                        <i className="ri-arrow-right-line text-neutral-400 transition group-hover:translate-x-1 group-hover:text-theme" />
                    </a>
